...
Route::middleware(['auth', 'admin'])
    ...
    ->group(function () {
        ...
        Route::post(
            ...
            [AdminController::class, 'updateUserProcurementAccess']
        )->whereNumber('userId')->name('users.procurement-access');
...
Route::middleware(['auth', 'accounting'])
    ...
    ->group(function () {
        ...
        Route::post(
            '/saved-signatures',
            [AccountingController::class, 'storeSavedSignature']
        )->name('accounting.saved-signatures.store');

        Route::delete(
            '/saved-signatures/{signature}',
            [AccountingController::class, 'destroySavedSignature']
        )->whereNumber('signature')->name('accounting.saved-signatures.destroy');
...
Route::middleware(['auth', 'receiving'])
    ...
    ->group(function () {
        ...
        Route::post(
            '/saved-signatures',
            [ReceivingController::class, 'storeSavedSignature']
        )->name('receiving.saved-signatures.store');
        Route::delete(
            '/saved-signatures/{signature}',
            [ReceivingController::class, 'destroySavedSignature']
        )->whereNumber('signature')->name('receiving.saved-signatures.destroy');
