@php
    ...
    $roleName = $settingsUser->role->role_name ?? 'Purchaser';
    $isProfile = request()->is('purchaser/profile*');
    $isSecurity = request()->is('purchaser/security*');
...
<div class="mb-6 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
    <div class="flex flex-col gap-4 border-b border-slate-200 px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
        <div class="flex items-center gap-4">
            <div class="flex h-14 w-14 shrink-0 items-center justify-center overflow-hidden rounded-full bg-[#0025cc] text-lg font-semibold text-white">
