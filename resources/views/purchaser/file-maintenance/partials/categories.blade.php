                ...
                <form method="POST" :action="openModal === 'create' ? @js(route('purchaser.categories.store')) : (`{{ url('/purchaser/categories') }}/${form.id}`)">
                    ...
                    <div class="flex items-start justify-between gap-4 border-b border-gray-100 px-5 py-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 id="category-form-title" class="text-lg font-semibold tracking-tight text-gray-950" x-text="openModal === 'create' ? 'Add Category' : 'Edit Category'"></h3>
                                <p class="mt-0.5 text-sm text-gray-500">Procurement item category.</p>
                            </div>
                        </div>
                    ...
                    <div class="flex justify-end gap-3 border-t border-gray-100 bg-gray-50 px-5 py-4">
                        ...
                        <button type="submit" class="inline-flex items-center gap-2 rounded-lg bg-[#0025cc] px-4 py-2.5 text-[13px] font-semibold text-white shadow-sm transition hover:bg-blue-800">
                            ...
                            <span x-text="openModal === 'create' ? 'Save Category' : 'Update Category'"></span>
                        </button>
                    </div>
                </form>
            </div>
