...
@section("page-subtitle", "Manage procurement liquidation records")
...
<div>
        ...
        <div class="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div>
                ...
                <p class="mt-2 max-w-2xl text-sm leading-6 text-gray-500">
                    Track liquidation records, expenses, balances, and supporting documents.
                </p>
            </div>
    ...
    <div class="mb-6 overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
        ...
        <div class="grid grid-cols-2 divide-gray-100 sm:grid-cols-3 lg:grid-cols-5 lg:divide-x">
            ...
            <div class="px-5 py-5">
                <p class="text-2xl font-semibold tracking-tight text-gray-950">0</p>
                <p class="mt-1 text-xs font-medium text-gray-500">For Review</p>
            </div>
            ...
            <div class="px-5 py-5">
                <p class="text-2xl font-semibold tracking-tight text-gray-950">₱0.00</p>
                <p class="mt-1 text-xs font-medium text-gray-500">Total Liquidated</p>
            </div>
            ...
            <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-400">
                        View and manage procurement liquidation records.
                    </p>
                </div>
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-16 text-center">
                            ...
                            <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-xl bg-gray-100">
                                ...
                                >
                                    <path
                                        ...
                                        stroke-linejoin="round"
                                        stroke-width="1.8"
                                        d="M9 14 11 16 15 12M7 3h10a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2Z"
                                    />
                                </svg>
                            ...
                            <p class="mt-1 text-sm text-gray-400">
                                Liquidation records will appear here once they are created.
                            </p>
