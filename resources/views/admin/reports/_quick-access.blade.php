...
<div class="space-y-4 p-1">
    <div class="flex flex-wrap gap-2">
        <button type="button" class="qa-report-tab rounded-xl border border-[#0037c7] bg-[#0037c7] px-3 py-2 text-sm font-semibold text-white" data-pane="qa-pane-maintenance" onclick="window.switchQaReportTab(this)">Maintenance</button>
    ...
    <div id="qa-pane-maintenance" class="qa-report-pane space-y-4">
        <div class="grid grid-cols-2 gap-3 xl:grid-cols-4">
            ...
            <div class="rounded-xl border border-gray-200 px-4 py-3"><p class="text-xs font-semibold uppercase text-gray-500">Resolved</p><p class="mt-1 font-['Outfit'] text-2xl font-bold text-emerald-700">{{ $m['resolved'] ?? 0 }}</p></div>
            <div class="rounded-xl border border-gray-200 px-4 py-3"><p class="text-xs font-semibold uppercase text-gray-500">Rejected</p><p class="mt-1 font-['Outfit'] text-2xl font-bold text-rose-600">{{ $m['rejected'] ?? 0 }}</p></div>
            <div class="rounded-xl border border-gray-200 px-4 py-3"><p class="text-xs font-semibold uppercase text-gray-500">Replacement</p><p class="mt-1 font-['Outfit'] text-2xl font-bold text-amber-600">{{ $m['replacement'] ?? 0 }}</p></div>
        </div>
    ...
    <div id="qa-pane-receiving" class="qa-report-pane space-y-4 hidden">
        <div class="grid grid-cols-2 gap-3 xl:grid-cols-4">
            <div class="rounded-xl border border-gray-200 px-4 py-3"><p class="text-xs font-semibold uppercase text-gray-500">Accepted</p><p class="mt-1 font-['Outfit'] text-2xl font-bold text-emerald-700">{{ $r['accepted'] ?? 0 }}</p></div>
            <div class="rounded-xl border border-gray-200 px-4 py-3"><p class="text-xs font-semibold uppercase text-gray-500">Returned</p><p class="mt-1 font-['Outfit'] text-2xl font-bold text-rose-600">{{ $r['returned'] ?? 0 }}</p></div>
