...
<div class="admin-page space-y-6">
    <header>
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div class="min-w-0">
                <h1 class="truncate text-2xl font-bold tracking-tight text-slate-950 sm:text-3xl">
                    {{ $equipment->equipment_name }}
                </h1>
                <p class="mt-1 text-sm text-slate-500">Read-only asset record. Day-to-day edits stay with Maintenance.</p>
                ...
                <div class="grid grid-cols-1 gap-6 px-6 py-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-slate-900">
                            ...
                            @else
                                {{ $na(null) }} <span class="text-xs font-normal text-slate-400">(default {{ $usefulLifeYears }} years)</span>
                            @endif
                        </p>
                    </div>
                </div>
