            ...
            <table class="w-full text-black">
                ...
                <tbody>
                    @foreach ($equipment as $item)
                        <tr class="border-t">
                            <td class="p-4">{{ $item->equipment_name }}</td>
    ...
    >
        <div class="w-full max-w-md rounded-3xl bg-white p-6">
            <div class="mb-4 flex items-center justify-between">
                <h2 id="qrEquipmentName" class="text-xl font-bold">QR Code</h2>

                <button onclick="closeQrModal()" class="text-2xl">
                    &times;
                </button>
            </div>

            <div id="qrPreview" class="mb-4 flex justify-center"></div>
