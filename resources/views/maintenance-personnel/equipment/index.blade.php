...
@section ("content")
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div class="rounded-2xl border border-green-200 bg-white p-5">
                ...
                <h2 class="mt-2 text-3xl font-black text-green-700">
                    {{
                        $equipment
            ...
            <div class="rounded-2xl border border-amber-200 bg-white p-5">
                <p class="text-sm text-amber-600">Under Maintenance</p>
            ...
            <div class="rounded-2xl border border-red-200 bg-white p-5">
                <p class="text-sm text-red-600">Disposed</p>
                ...
                <table class="w-full">
                    <thead class="bg-slate-50">
                        <tr class="text-sm text-slate-700">
                            <th class="p-4 text-left">Asset Tag</th>
                                ...
                                <td class="p-4">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        '{{ $item->equipment_is_borrowable ? 'Yes' : 'No' }}'
                                            ...
                                            class="rounded-lg border border-slate-300 px-3 py-2 text-slate-700 hover:bg-slate-100"
                                        >
                                            View
                                        </button>
    ...
    >
        <div
            class="w-full max-w-6xl overflow-hidden rounded-3xl bg-white shadow-2xl"
        >
            <div class="flex items-center justify-between border-b px-6 py-5">
                <h2 class="text-2xl font-bold text-slate-900">Add Equipment</h2>
            ...
            <form action="/maintenance/equipment/store" method="POST">
                @csrf
