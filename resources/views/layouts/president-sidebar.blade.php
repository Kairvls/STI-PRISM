<div id="sidebar">
    ...
    <div class="sidebar-content">
        ...
        <div class="menu-title" id="approvals-section">
        ...
        <a
            href="/president/approvals"
            class="menu-item {{ request()->is('president/approvals') ? 'active' : '' }}"
        >
        ...
        <a
            href="/president/reports/monthly-summary"
            class="menu-item {{ request()->is('president/reports/monthly-summary') ? 'active' : '' }}"
        >
