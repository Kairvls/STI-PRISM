        ...
        <div id="messagingModalContainer" class="relative mx-4 w-full max-w-[960px] h-[85vh] max-h-[720px] bg-white rounded-2xl shadow-[0_25px_60px_rgba(0,0,0,0.25)] overflow-hidden scale-[0.95] opacity-0 transition-all duration-300 ease-out flex">
            ...
            <aside class="w-full md:w-[340px] lg:w-[360px] shrink-0 border-r border-gray-200 flex flex-col bg-white">
                ...
                <div id="modalUsersSection" class="hidden flex-1 flex flex-col overflow-hidden">
                    ...
                    {{-- Users Grid --}}
                    <div id="modalUsersContainer" class="flex-1 overflow-y-auto px-3 pb-3">
...
(function() {
    ...
    function renderModalUsers(users) {
        ...
        container.innerHTML = users.map(user => `
            <button type="button" data-user-id="${user.user_id}" class="user-card w-full text-left p-3 rounded-xl border border-gray-200 bg-white hover:border-gray-300 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 cursor-pointer">
                <div class="flex flex-col items-center text-center gap-2">
                    <div class="h-10 w-10 rounded-full bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center text-xs font-semibold text-gray-600">
                        ${user.initials}
                    </div>
                    ...
                    <div class="inline-flex items-center gap-1 text-gray-900">
...
<style>
    ...
    .user-card {
        animation: userCardIn 0.3s ease-out;
    }
