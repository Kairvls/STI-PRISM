...
<div class="admin-page space-y-6">
    <div>
        ...
        <p class="admin-page-subtitle">Alerts for deliveries and receiving activity.</p>
    </div>
</div>
    ...
    <div class="rounded-[18px] border border-gray-200 bg-white">
        ...
        @empty
            <div class="px-5 py-16 text-center text-sm text-gray-500">No receiving notifications yet.</div>
        @endforelse
    </div>
</div>
