...
<style>
    ...
    .ris-document .signature-line .signature-image { max-height: 38px; max-width: 90%; top: 50%; bottom: auto; }
    .ris-document .signature-line .signature-name { display: block; position: relative; z-index: 1; line-height: 1.35; }
