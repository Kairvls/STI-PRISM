...
class AccountingViewServiceProvider extends ServiceProvider
{
        ...
        View::composer(
            ...
            function ($view) {
                ...
                if (! $userId || ! Schema::hasTable('notifications_table')) {
                    try {
                        if ($userId) {
                            $attentionTotal = (int) (AccountingAttentionSummary::counts()['attentionTotal'] ?? 0);
                        }
                    } catch (\Throwable $e) {
                        $attentionTotal = 0;
                    }
